...
async function fetchInterpretation(id: string) {
  try {
    ...
    console.error("error in fetching interpretation:", error);
...
async function deleteInterpretation(id: string) {
  try {
    ...
    console.error("error in deleting interpretation:", error);
...
async function updateInterpretation(
  ...
  try {
    ...
    console.error("error in updating interpretation:", error);
...
export async function PUT(
  ...
  try {
    ...
    console.log("Received data:", interpretation);
